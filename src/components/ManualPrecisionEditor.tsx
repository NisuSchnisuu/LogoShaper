        ...
        <div className="flex flex-col h-screen overflow-hidden bg-background-dark text-white font-display w-full md:max-w-7xl md:mx-auto">
            ...
            <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
                ...
                <main className="relative flex-1 w-full bg-background-dark overflow-hidden flex items-center justify-center">
                    ...
                    {/* The Editing Canvas */}
                    <div
                        className="relative z-10 w-72 h-72 md:w-96 md:h-96 shadow-[0_0_0_9999px_rgba(10,10,12,0.85)] border border-white/20 transition-all duration-300 ease-out overflow-hidden"
                        style={{
                            borderRadius: `${radius}%`,
                            backgroundColor: background === 'grid' ? '#1c1c1f' : 'transparent'
                        }}
                    >
                        {background === 'grid' && (
